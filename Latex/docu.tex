...
\begin{document}
	...
	\begin{verbatim}
		...
		RUTA PARA NIÑOS: Perfecta para familias con actividades interactivas y obras accesibles para los más pequeños, sin tanta complejidad.
		...
		[Sala4]:
		- Obra: [ImpresiónSolNaciente]
		Autor: [ClaudeMonet]
		Estilo: [ArteModerno]
		- Obra: [MujerConSombrilla]
		Autor: [ClaudeMonet]
		Estilo: [ArteModerno]
		- Obra: [Nenúfares]
		Autor: [ClaudeMonet]
		...
		Autor: [MiguelAngel]
		Estilo: [Renacimiento]
		- Obra: [ElHombreDeVitruvio]
		Autor: [LeonardoDaVinci]
		Estilo: [Renacimiento]
		- Obra: [LaDamaDelArmiño]
		Autor: [LeonardoDaVinci]
		Estilo: [Renacimiento]
		- Obra: [Moisés]
		Autor: [MiguelAngel]
		...
		[Sala3]:
		- Obra: [CisnesReflejandoElefantes]
		Autor: [SalvadorDalí]
		Estilo: [ArteModerno]
		...
		Estilo: [ArteModerno]
		- Obra: [SueñoCausadoPorElVueloDeUnaAbeja]
		Autor: [SalvadorDalí]
		Estilo: [ArteModerno]
	...
	\begin{verbatim}
		...
		[Sala2]:
		- Obra: [CristoCrucificado]
		Autor: [DiegoVelázquez]
		Estilo: [Barroco]
		- Obra: [ElDescendimientoDeLaCruz]
		Autor: [PeterPaulRubens]
		Estilo: [Barroco]
		- Obra: [ElJardínDelAmor]
		Autor: [PeterPaulRubens]
		Estilo: [Barroco]
		- Obra: [ElJuicioDeParis]
		Autor: [PeterPaulRubens]
		Estilo: [Barroco]
		- Obra: [ElTriumfoDeBaco]
		Autor: [DiegoVelázquez]
		Estilo: [Barroco]
		- Obra: [JudithDecapitandoAHolofernes]
		Autor: [Caravaggio]
		Estilo: [Barroco]
		- Obra: [LaAdoraciónDeLosMagos]
		Autor: [PeterPaulRubens]
		Estilo: [Barroco]
		- Obra: [LaCenaDeEmaús]
		Autor: [Caravaggio]
		Estilo: [Barroco]
		- Obra: [LaFraguaDeVulcano]
		Autor: [DiegoVelázquez]
		Estilo: [Barroco]
		- Obra: [LaRendiciónDeBreda]
		Autor: [DiegoVelázquez]
		Estilo: [Barroco]
		- Obra: [LaVocaciónDeSanMateo]
		Autor: [Caravaggio]
		Estilo: [Barroco]
		- Obra: [LasMeninas]
		Autor: [DiegoVelázquez]
	...
	\begin{verbatim}
		...
		Autor: [DiegoVelázquez]
		Estilo: [Barroco]
		- Obra: [LaIncredulidadDeSantoTomás]
		Autor: [Caravaggio]
		Estilo: [Barroco]
		- Obra: [LaRendiciónDeBreda]
		Autor: [DiegoVelázquez]
	...
	\begin{verbatim}
		...
		Autor: [WassilyKandinsky]
		Estilo: [ArteModerno]
		- Obra: [CuadradoConCírculosConcéntricos]
		Autor: [WassilyKandinsky]
		Estilo: [ArteModerno]
		- Obra: [Improvisación28]
		Autor: [WassilyKandinsky]
		Estilo: [ArteModerno]
	...
	\begin{verbatim}
		...
		[Sala4]:
		- Obra: [ElEstanqueDeNenúfares]
		Autor: [ClaudeMonet]
		Estilo: [ArteModerno]
		- Obra: [ImpresiónSolNaciente]
		Autor: [ClaudeMonet]
		Estilo: [ArteModerno]
		- Obra: [LaCatedralDeRuanEfectoDeSol]
		Autor: [ClaudeMonet]
		Estilo: [ArteModerno]
		- Obra: [MujerConSombrilla]
		Autor: [ClaudeMonet]
		...
		[Sala3]:
		- Obra: [AutorretratoConOrejaVendada]
		Autor: [VincentVanGogh]
		Estilo: [ArteModerno]
		- Obra: [CampoDeTrigoConCuervos]
		Autor: [VincentVanGogh]
		Estilo: [ArteModerno]
		- Obra: [CisnesReflejandoElefantes]
		Autor: [SalvadorDalí]
		Estilo: [ArteModerno]
		- Obra: [CristoDeSanJuanDeLaCruz]
		Autor: [SalvadorDalí]
		Estilo: [ArteModerno]
		- Obra: [ElGranMasturbador]
		Autor: [SalvadorDalí]
		Estilo: [ArteModerno]
		- Obra: [ElGuitarristaViejo]
		Autor: [PabloPicasso]
		Estilo: [ArteModerno]
		- Obra: [Guernica]
		Autor: [PabloPicasso]
		Estilo: [ArteModerno]
		- Obra: [LaHabitaciónEnArlés]
		Autor: [VincentVanGogh]
		Estilo: [ArteModerno]
		- Obra: [LaMujerQueLlora]
		Autor: [PabloPicasso]
		Estilo: [ArteModerno]
		- Obra: [LaNocheEstrellada]
		Autor: [VincentVanGogh]
